...
module.exports = function(router) {
    ...
    router.put('/resend', function(req, res) {
        User.findOne({ username: req.body.username }).select('username name email temporarytoken aboutme').exec(function(err, user) {
            if (err) {
                // Create an e-mail object that contains the error. Set to automatically send it to myself for troubleshooting.
                var email = {
                    from: 'MUNSSN',
                ...
                user.temporarytoken = jwt.sign({ username: user.username, email: user.email, aboutme: user.aboutme}, secret, { expiresIn: '1h' }); // Give the user a new token to reset password
    ...
    router.put('/resetpassword', function(req, res) {
        User.findOne({ username: req.body.username }).select('username active email resettoken name aboutme').exec(function(err, user) {
            if (err) {
                // Create an e-mail object that contains the error. Set to automatically send it to myself for troubleshooting.
                var email = {
                    from: 'MUNSSN',
                ...
                if (!user) {
                    ...
                    user.resettoken = jwt.sign({ username: user.username, email: user.email, aboutme: user.aboutme}, secret, { expiresIn: '1h' }); // Create a token for activating account through e-mail
    ...
    router.put('/savepassword', function(req, res) {
        User.findOne({ username: req.body.username }).select('username email name password resettoken aboutme').exec(function(err, user) {
            if (err) {
                // Create an e-mail object that contains the error. Set to automatically send it to myself for troubleshooting.
                var email = {
                    from: 'MUNSSN',
                    ...
                    user.save(function(err) {
                        if (err) {
                            ...
                            var email = {
                                ...
                                text: 'Hello ' + user.email + ', This e-mail is to notify you that your password was recently reset at MUNSSN',
    ...
    router.get('/renewToken/:username', function(req, res) {
        User.findOne({ username: req.params.username }).select('username email aboutme').exec(function(err, user) {
            if (err) {
                // Create an e-mail object that contains the error. Set to automatically send it to myself for troubleshooting.
                var email = {
                    from: 'MUNSSN',
                ...
                if (!user) {
                    ...
                    var newToken = jwt.sign({ username: user.username, email: user.email, aboutme: user.aboutme }, secret, { expiresIn: '1h' }); // Give user a new token
