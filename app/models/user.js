...
var UserSchema = new Schema({
    ...
    aboutme: {type: String, default: 'This user has not yet updated their about me', required: true},
    resume: {type: String, default: 'This user has not yet updated their resume', required: true},
    schedule: {type: String, default: 'This user has not yet updated their schedule', required: true}, //for this one, a simple might not cut it, but for now this is it. 
    avatar: { data: Buffer, contentType: String, type: String, default:'4AAQSkZJRgABAQAASABIAAD', required: true}
